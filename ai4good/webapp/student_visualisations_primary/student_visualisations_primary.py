...
fig.update_layout(
    ...
    title = "Parameters for Age Group: 0-9 (from expected result file)",yaxis=dict(
                title='Total Population (Age: 0-9)', showspikes = True,

spikemode  = 'across+toaxis'),xaxis=dict(
                title='Time, Days', showspikes = True,
...
fig2.update_layout(
    ...
    title = "Parameters for Age Group: 10-19 ",yaxis=dict(
                title='Total Population (Age: 10-19)', showspikes=True, spikemode='across+toaxis'),xaxis=dict(
                title='Time, Days',showspikes=True, spikemode='across+toaxis',
                ), hovermode='x'
)
